...
/**
 * Classe de Menu
 * Description des règles dans Readme.md
 * @author KOZLOV-PC
 *
 */
public class Menu {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		//Différentes options pour les JOptionPane
	...
	public static void saveScore(int scoreMonstre, int scoreChasseur) throws IOException {
		String[] score1 = {Menu.pseudoJoueur1, String.valueOf(scoreMonstre), "Monstre"};
        String[] score2 = {Menu.pseudoJoueur2, String.valueOf(scoreChasseur), "Chasseur"};
        CSVWriter writer = new CSVWriter(new FileWriter(Menu.PATH_TO_CSV, true));
